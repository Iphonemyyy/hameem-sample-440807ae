...
export const Contact = ({ isArabic }: ContactProps) => {
  ...
  const content = {
    ar: {
      ...
      hours: [
        { day: "الأحد", time: "9:00 صباحاً - 5:00 مساءً" },
        { day: "الإثنين", time: "9:00 صباحاً - 5:00 مساءً" },
        { day: "الثلاثاء", time: "9:00 صباحاً - 5:00 مساءً" },
        { day: "الأربعاء", time: "9:00 صباحاً - 5:00 مساءً" },
        { day: "الخميس", time: "9:00 صباحاً - 5:00 مساءً" },
